...
folder_names = ['without_COS','original','nn1','AsQrdqn','residual','norm','Wang75']

def polt_EWMA_compare():
    
    plt.figure(figsize = (10,5))
    plt.title('EWMA compare collected over time (PendulumEnv)')
    plt.xlabel('Episode')
    ...
    plt.legend(loc='best')
    plt.savefig('PIC/PendulumEnv-compare.png')
    plt.show()
