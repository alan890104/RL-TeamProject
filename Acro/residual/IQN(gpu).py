...
class net(nn.Module):
    ...
    '''
    def __init__(self, n_states=6, n_actions=3, quant_num = 64):
        ...
        # for state S to V
        self.convert_to_V = nn.Linear(6,128) 
...
class IQN(object):
    ...
    def train(self,ID):
        ...
        print('start'+str(ID))
        EWMA_reward = None
        f1 = open('Data/Acrobot-v1_EWMA' + str(ID) + '.txt', 'w+')
        f2 = open('Data/Acrobot-v1_score' + str(ID) + '.txt', 'w+')
