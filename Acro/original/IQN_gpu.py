...
class IQN(object):
    ...
    def train(self, ID):
        ...
        for i in range(self.episode):
            ...
            print('episode: {}\t score: {}\t EWMA_reward: {}'.format(
                i, score, EWMA_reward))
...
def main(ID):
    ...
    a = IQN(env, episode=4000, epsilon=0.05,
            learning_rate=1e-4, gamma=0.95, quant_num=64)
    a.train(ID)
